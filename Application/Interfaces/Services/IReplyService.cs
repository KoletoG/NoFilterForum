...
namespace NoFilterForum.Core.Interfaces.Services
{
    public interface IReplyService
    {
        ...
        public Task<IReadOnlyCollection<ReplyIndexItemDto>> GetListReplyIndexItemDto(GetListReplyIndexItemRequest getListReplyIndexItemRequest);
        public Task<IReadOnlyCollection<ReplyItemDto>> GetListReplyItemDtoAsync(string userId);
