...
namespace Application.Interfaces.Services
{
    public interface ICacheService
    {
        ...
        public Task<T?> TryGetValue<T>(string key, Func<int, CancellationToken, Task<T>> unitOfWorkMethod, int page, CancellationToken token, int seconds = 15, int minutes = 0);
