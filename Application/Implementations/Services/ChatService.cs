...
namespace Application.Implementations.Services
{
    public class ChatService : IChatService
    {
        ...
        {
            return await _unitOfWork.Chats.GetAll().Where(x=>x.User1.Id==userId || x.User2.Id==userId).Select(x => new IndexChatDTO(x.Id, x.User1.UserName! == username ? x.User2.UserName! : x.User1.UserName!, x.Messages,userId == x.User1.Id ? x.User2.Role : x.User1.Role,userId==x.User1.Id ? x.User2.Id : x.User1.Id)).ToListAsync(cancellationToken);
        }
