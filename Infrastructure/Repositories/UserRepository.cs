...
namespace NoFilterForum.Infrastructure.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<bool> ExistsUsernameAsync(string username, CancellationToken cancellationToken) => await _context.Users.AnyAsync(x=>x.UserName == username, cancellationToken);
