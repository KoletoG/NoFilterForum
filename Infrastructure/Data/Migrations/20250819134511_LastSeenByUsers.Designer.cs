...
namespace NoFilterForum.Migrations
{
    ...
    [Migration("20250819134511_LastSeenByUsers")]
    partial class LastSeenByUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.DataModels.ChatDataModel", b =>
                {
                    ...
                    b.Property<string>("LastSeenByUser1Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("LastSeenByUser2Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("LastSeenByUser1Id");

                    b.HasIndex("LastSeenByUser2Id");
            ...
            modelBuilder.Entity("Core.Models.DataModels.ChatDataModel", b =>
                {
                    b.HasOne("Core.Models.DataModels.MessageDataModel", "LastSeenByUser1")
                        .WithMany()
                        .HasForeignKey("LastSeenByUser1Id");

                    b.HasOne("Core.Models.DataModels.MessageDataModel", "LastSeenByUser2")
                        .WithMany()
                        .HasForeignKey("LastSeenByUser2Id");
                    ...
                    b.Navigation("LastSeenByUser1");

                    b.Navigation("LastSeenByUser2");
